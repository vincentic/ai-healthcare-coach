...
from app.routes import auth, practice, conversation, progress, settings, shadow_reading_steps, i1_progression
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        print("   Static frontend fallback remains available")
    yield
